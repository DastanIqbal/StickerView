...
public class StickerView extends FrameLayout {
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            borderLinePaint.setColor(a.getColor(R.styleable.StickerView_borderColor, Color.BLACK));
            borderLinePaint.setStrokeWidth(5);
    ...
    public void configDefaultIcons() {
        BitmapStickerIcon deleteIcon = new BitmapStickerIcon(getContext(),
                ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_close_white_18dp),
                BitmapStickerIcon.LEFT_TOP);
        deleteIcon.setIconEvent(new DeleteIconEvent());
        BitmapStickerIcon zoomIcon = new BitmapStickerIcon(getContext(),
                ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_scale_white_18dp),
                BitmapStickerIcon.RIGHT_BOTOM);
        zoomIcon.setIconEvent(new ZoomIconEvent());
        BitmapStickerIcon flipIcon = new BitmapStickerIcon(getContext(),
...
//            Log.d(TAG, "BorderWidth " + (x2 - x1));
    ...
    public PointF getUIViewXY(float w, float h, PointF currentCenterPoint) {
        float width = getWidth();
        float height = getHeight();
        float aspectRW = width / w;
        float aspectRH = height / h;
        float x = currentCenterPoint.x / aspectRW;
        float y = currentCenterPoint.y / aspectRH;
